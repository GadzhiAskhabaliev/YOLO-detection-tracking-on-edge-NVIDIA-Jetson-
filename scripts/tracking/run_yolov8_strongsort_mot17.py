#!/usr/bin/env python3
"""Run YOLOv8 detections + StrongSORT tracking on video or MOT17 img1 folder."""
...
def main() -> None:
    ...
    parser.add_argument("--name", default="yolov8_strongsort")
    ...
    try:
        ...
        raise SystemExit("boxmot is required for StrongSORT: pip install boxmot") from exc
    ...
    video_path = run_dir / "strongsort_tracks.mp4"
